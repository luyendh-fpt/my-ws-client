...
public class MyServiceServiceLocator extends org.apache.axis.client.Service implements bankservice.MyServiceService {
    ...
    public bankservice.MyService getMyServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            bankservice.MyServicePortBindingStub _stub = new bankservice.MyServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (bankservice.MyService.class.isAssignableFrom(serviceEndpointInterface)) {
                bankservice.MyServicePortBindingStub _stub = new bankservice.MyServicePortBindingStub(new java.net.URL(MyServicePort_address), this);
                _stub.setPortName(getMyServicePortWSDDServiceName());
                return _stub;
            }
        }
